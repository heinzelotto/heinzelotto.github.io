import{h as i,j as a,t as l}from"./index-nyNd6dkY.js";function c({id:n}){var o;const e=i(s=>s.index.get(n));if(!e||e.solved===null)return null;const t=e.spectator===!0,r=`solved ${t?"delivered conditional (refinement)":e.kind==="statement"?"marginal":"in-force rate"} ${e.solved.toFixed(3)}`+(e.authored!==null?`
