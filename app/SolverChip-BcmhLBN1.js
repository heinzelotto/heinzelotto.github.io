import{m as u,u as h,dM as m,dN as p,dO as v,aH as x,dP as k,bp as $,l as f,bq as g}from"./styles-CC7UCaQW.js";const F=x.en;function C({id:s,vocab:i}){var l;const e=u(o=>o.index.get(s)),r=h(o=>o.analysis.statements);if(!e||e.solved===null)return null;const t=e.spectator===!0,n=e.kind==="statement"&&e.authored===null&&!t?m(r).get(s)??null:null,a=n===null?null:Math.abs(p(n,e.solved)),d=t?"delivered conditional (refinement)":e.kind==="statement"?"marginal":"in-force rate",c=`${v(i??F,e.authored!==null?e.authored.toFixed(2):null,e.solved.toFixed(2),t)}
