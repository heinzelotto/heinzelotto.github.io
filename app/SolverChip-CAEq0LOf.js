import{v as i,j as a,w as l}from"./index-CgR-RA7E.js";function c({id:n}){var o;const e=i(s=>s.index.get(n));if(!e||e.solved===null)return null;const t=e.spectator===!0,r=`solved ${t?"delivered conditional (refinement)":e.kind==="statement"?"marginal":"in-force rate"} ${e.solved.toFixed(3)}`+(e.authored!==null?`
